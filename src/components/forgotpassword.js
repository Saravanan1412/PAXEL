...
import FG from "../assests/forgot-password.png"
const Forgot = () => {
  ...
  return (
        ...
        <div className='sm:flex sm:flex-row items-center justify-center sm:h-screen sm:space-x-48 sm:text-xl h-screen flex flex-col'>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <button className="text-[13px] text-[#00203f] bg-[#ADEFD1] mt-10 bg- h-8 w-48 sm:w-72 rounded-xl sm:p-1 p-2 ">RESET PASSWORD</button>
